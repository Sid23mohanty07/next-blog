    ...
    <footer className="bg-gray-100 py-8 dark:bg-gray-800 mt-10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-md font-semibold">HeisenBerg Blog</span>
            </div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.linkedin.com/in/siddharthmohanty23/"
                target="_blank"
              ...
              <a
                href="https://github.com/Sid23mohanty07"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Github"
              >
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  href="mailto:siddharthmohanty23@gmail.com"
                  className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300"
                >
                  Contact
                </a>
        ...
        <div className="mt-8 border-t border-gray-200 pt-4 text-center text-xs text-gray-500 dark:border-gray-700 dark:text-gray-400">
          &copy; 2024 HeisenBerg Blogs. All rights reserved.
        </div>
      </div>
    </footer>
  );
